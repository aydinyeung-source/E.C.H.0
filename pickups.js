...
// Weighted item table. Crucifixes are RARE — they're a full escape button, so
// finding them constantly would defang the whole game. Torches are CONSUMABLE
// (each one burns out for good), so they have to be findable enough to be worth
// carrying.
const ITEM_TABLE = [
  ["meat", 0.69],
  ["torch", 0.22],
...
export class Pickups {
  constructor(scene) {
    ...
    // A torch: a dark barrel with a bright lens. Always found fully charged.
